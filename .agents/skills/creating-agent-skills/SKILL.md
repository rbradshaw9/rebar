...
description: Creates Antigravity agent skills in the correct folder structure with SKILL.md and YAML frontmatter. Use when the user asks to build or create a new skill for the agent.
---
